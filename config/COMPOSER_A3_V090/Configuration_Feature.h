...
//Change to T0 - prepare - prepare_fast - start - switch - finish
#define CHANGE_T0_X {-40.0+68, -40.0+68, -40.0+68, -50.0+68, -50.0+68,   -50.0+68,  -40.0+68,  -40.0+68,   -40.0+68}
#define CHANGE_T0_Y {  130,   200,   290,   290,   275,     290,    290,    200,     130}
#define CHANGE_T0_F {  200,    40,   200,   200,    50,     200,    200,    200,      40}

//Change to T1 - prepare - prepare_fast - start - switch - finish
#define CHANGE_T1_X {-40.0+68,  -40.0+68,  -50.0+68, -50.0+68,  -50.0+68, -40.0+68, -40.0+68,   -40.0+68,  -40.0+68}
#define CHANGE_T1_Y {130.0,  200.0,  260.0, 270.0,  260.0, 200.0, 128.0,   129.0,  130.0}
#define CHANGE_T1_F {  200,     40,    200,    50,    200,   200,    40,      40,     40}
