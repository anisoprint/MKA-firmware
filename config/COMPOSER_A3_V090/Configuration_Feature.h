...
//Change to T0 - prepare - prepare_fast - start - switch - finish
#define CHANGE_T0_X {   28,    28,    28,    15,    15,      15,     26,     26,      26}
#define CHANGE_T0_Y {  130,   200,   280,   280,   275,     261,    261,    131,     130}
#define CHANGE_T0_F {  200,    40,   200,   200,   200,      50,    200,     40,      40}

//Change to T1 - prepare - prepare_fast - start - switch - finish
#define CHANGE_T1_X {   28,     28,     15,    15,     15,    25,    25,      25,     25}
#define CHANGE_T1_Y {130.0,  200.0,  260.0, 236.3,  250.3, 236.3, 132.0,   131.0,  130.0}
#define CHANGE_T1_F {  200,     40,    200,   200,     50,   200,    40,      40,     40}
