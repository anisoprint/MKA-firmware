...
//Change to T0 - prepare - prepare_fast - start - switch - finish
#define CHANGE_T0_X {  -40,   -40,   -40,   -53,   -53,     -53,    -42,    -42,     -42}
#define CHANGE_T0_Y {  137,   207,   287,   287,   282,     268,    268,    138,     137}
#define CHANGE_T0_F {  200,    40,   200,   200,   200,      50,    200,     40,      40}

//Change to T1 - prepare - prepare_fast - start - switch - finish
#define CHANGE_T1_X {  -40,    -40,    -53,   -53,    -53,   -43,   -43,     -43,   -43 }
#define CHANGE_T1_Y {137.0,  207.0,  207.0, 243.3,  257.3, 243.3, 139.0,   138.0,   137 }
