...
class SDCard {
  ...
  public: /** Public Parameters */
    ...
    static PrintFileInfo fileInfo;
    
    static uint16_t fileModifiedDate;
    static uint16_t fileModifiedTime;
  ...
  private: /** Private Function */
    ...
    static void readFileInfo(SdFile &file);
    static void clearFileInfo();
    static bool findFileInfo(const char *buf, uint16_t buf_length);
