 ...
 *                                                                     *
 ***********************************************************************/
#define HEATERS_PARALLEL //TODOAP HEATERS_PARALLEL
/***********************************************************************/
...
#define DEFAULT_Kp {7.2, 40, 40, 40}     // Kp for H0, H1, H2, H3
#define DEFAULT_Ki {0.34, 07, 07, 07}     // Ki for H0, H1, H2, H3
#define DEFAULT_Kd {37.81, 60, 60, 60}     // Kd for H0, H1, H2, H3
