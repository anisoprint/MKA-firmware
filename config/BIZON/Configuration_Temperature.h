...
#define DEFAULT_Kp {30.2, 40, 40, 40}     // Kp for H0, H1, H2, H3
#define DEFAULT_Ki {1.58, 07, 07, 07}     // Ki for H0, H1, H2, H3
#define DEFAULT_Kd {144, 60, 60, 60}     // Kd for H0, H1, H2, H3
...
#define DEFAULT_bedKp  345.99
#define DEFAULT_bedKi    35.67
#define DEFAULT_bedKd  838.99
